...
export class EtherDataService {
    ...
    getBIP39DerivationPath(index: string = '0'): string {
        return standardBIP39pathExcludingIndex + indexedDB;
    }
}
