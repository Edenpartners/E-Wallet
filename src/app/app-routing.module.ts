...
const routes: Routes = [
  ...
  { path: 'backup-wallet', loadChildren: './pages/wallet-management/backup-wallet/backup-wallet.module#BackupWalletPageModule' },
  { path: 'restore-wallet', loadChildren: './pages/wallet-management/restore-wallet/restore-wallet.module#RestoreWalletPageModule' },
  { path: 'backup-notice', loadChildren: './pages/wallet-management/backup-notice/backup-notice.module#BackupNoticePageModule' },
  { path: 'add-wallet', loadChildren: './pages/wallet-management/add-wallet/add-wallet.module#AddWalletPageModule' },
  ...
  { path: 'tw-main', loadChildren: './pages/tedn-wallet/tw-main/tw-main.module#TwMainPageModule' },
