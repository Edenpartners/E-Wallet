...
{
    NSLog(@"IonicDeeplinkPlugin pluginInitizalize");
    _handlers = [[NSMutableArray alloc] init];
    
    [[NSNotificationCenter defaultCenter] removeObserver:self name:CDVPluginHandleOpenURLNotification object:nil];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:CDVPluginHandleOpenURLWithAppSourceAndAnnotationNotification object:nil];
